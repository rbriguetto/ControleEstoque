...
public class ElasticsearchOptions
{
    ...
    public static ElasticsearchOptions FromConfiguration(IConfiguration configuration, string configurationRoot = "") => 
        new ElasticsearchOptions() { 
            Uri = configuration[$"{configurationRoot}{Section}:{nameof(ElasticsearchOptions.Uri)}"] ?? string.Empty,
            IndexName = configuration[$"{configurationRoot}{Section}:{nameof(ElasticsearchOptions.IndexName)}"] ?? string.Empty
        };
